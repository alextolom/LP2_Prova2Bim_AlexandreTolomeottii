 ...
 * @author radames
 */
class GUI_Diversos extends JFrame {
    ...
    private Controle_Diversos controle = new Controle_Diversos(); //essa é a classe de processamento (controle da lista de contatos)
    private Contato_Diversos contato = new Contato_Diversos(); //ver classe contato
        ...
        public boolean dispatchKeyEvent(KeyEvent e) {
            if (e.getID() == KeyEvent.KEY_PRESSED) {
                if (e.getKeyCode() == KeyEvent.VK_F1) {
                    color = corzinhabg.showDialog(null,"Escolha uma cor para o fundo", Color.YELLOW);
   ...
   return "<html><p style='background:#555;color:yellow'>" + message + "</p></html>"; 
    ...
    public GUI_Diversos() {
        //abrir o arquivo
        List<String> listaAuxiliar = fer.abrirArquivo("Catalogo de diversos.txt");
        if (listaAuxiliar != null) {
            for (int i = 0; i < listaAuxiliar.size(); i++) {
                String aux[] = listaAuxiliar.get(i).split(";");
                Contato_Diversos c = new Contato_Diversos(Integer.valueOf(aux[0]), aux[1], aux[2], aux[3]);
                controle.inserir(c);
...
//        usarGridBagLayoutCentro.add(lbMarca, tfMarca, lbModelo, tfModelo);
        ...
        btGravar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                fer.salvarArquivo("Catalogo de diversos.txt", listaStr);
...
//*********************** BOTÃO SALVAR ****************************************        
        btSalvar.addActionListener((ActionEvent e) -> {
            Contato_Diversos contatoOriginal = contato; //para pesquisar na lista
            //precisamos do contato original (para depois modificar)
            if (inserindo) {
                contato = new Contato_Diversos(); //criar um novo contato
            }
...
//======================= LISTAR =============================================
        btListar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String[] aux;
                colunas = new String[]{"ID do automóvel", "Marca", "Modelo","Data inserida"};
...
//$$$$$$$$$$$$$$ FIM DOS LISTENERS $$$$$$$$$$$$$
        ...
        setSize(840, 240);
        setTitle("Locadora de automóveis (Diversos)");
