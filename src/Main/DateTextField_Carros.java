...
public class DateTextField_Carros extends JTextField {
    ...
    public DateTextField_Carros() {
        this(new Date());
    }

    public DateTextField_Carros(String dateFormatPattern, Date date) {
        this(date);
        DEFAULT_DATE_FORMAT = dateFormatPattern;
    }

    public DateTextField_Carros(Date date) {
        setDate(date);
        setEditable(false);
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        Window owner = (Window) SwingUtilities
                .getWindowAncestor(DateTextField_Carros.this);
